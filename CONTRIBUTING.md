...
* GitHub Issues: <https://github.com/easyblueio/rules-engine/issues>
...
* easyblueio/rules-engine follows a superset of **[PSR-12 coding standard][psr-12]**.
  Please ensure your code does, too. _Hint: run `composer dev:lint` to check._
* Please **write tests** for any new features you add.
* Please **ensure that tests pass** before submitting your pull request.
  easyblueio/rules-engine automatically runs tests for pull requests. However,
...
[github]: https://github.com/easyblueio/rules-engine
[issues]: https://github.com/easyblueio/rules-engine/issues
[pull requests]: https://github.com/easyblueio/rules-engine/pulls
